    ...
    <div class="box-fluid">
        ...
        <div class="login-container">
            <div class="title-container-signup">
                <p class="title-text-signup">Create an account.</p>
            </div>
            <form class="login-form" action=".">
                ...
                <div class=" field">
                    <label for="pass">Enter the password again</label>
                    <input type="password" name="pass" class="input" v-model="r_password" placeholder="" />
                </div>

                <div class="strenght">
                    <span class="bar bar-1" v-bind:class="{ 'bar-show': strenghtLevel >= 1 }"></span>
                    <span class="bar bar-2" v-bind:class="{ 'bar-show': strenghtLevel >= 2 }"></span>
                    <span class="bar bar-3" v-bind:class="{ 'bar-show': strenghtLevel >= 3 }"></span>
                    <span class="bar bar-4" v-bind:class="{ 'bar-show': strenghtLevel >= 4 }"></span>
                </div>
                <br />
                <button type="submit" class="create" @click="register">Create</button>
            </form>
